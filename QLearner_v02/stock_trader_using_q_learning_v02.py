# -*- coding: utf-8 -*-
"""Stock_Trader_Using_Q_Learning (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zMELWo2fqnD7rIeBJ5AGGj4mJ48rp9Mg
"""
...
1. Get the state for cash  ()
2. Get the state for shares
3. 
4. 
5.
"""
...
train_df = create_df(train_df, 10)

train_df.head()

train_df[train_df.percent_b > 100 ]
...
train_df.percent_b_state.value_counts()

all_states = get_all_states(percent_b_states_values, close_sma_ratio_states_value)
...
test_df.percent_b_state.value_counts()

test_df.norm_close_sma_ratio_state.value_counts()
