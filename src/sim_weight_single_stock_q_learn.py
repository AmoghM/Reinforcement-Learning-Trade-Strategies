...
def qlearner(stock_table,money,inc, original_shares, qtable=nq, BB_quantiles= bb_ , SMA_quantiles = sma_, window=3): # defining defaults here prevents need for args to be passed in return_stats function
    '''
    Enacts qlearning
